    ...
    return Container(
        ...
        child: GestureDetector(
          onTapUp: (tapInfo) {
            ...
            var topLeftTouched = localTouchPosition.dy < size / 2 &&
                localTouchPosition.dx < size / 2;

            var topRightTouched = localTouchPosition.dy < size / 2 &&
                localTouchPosition.dx > size / 2;

            var bottomLeftTouched = localTouchPosition.dy > size / 2 &&
                localTouchPosition.dx < size / 2;

            var bottomRightTouched = localTouchPosition.dy > size / 2 &&
                localTouchPosition.dx > size / 2;
